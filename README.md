...
تشغيل جهازك. الكابشن = نص الحديث كامل (السند + المتن + المصدر). لا يكرّر أي بوست (سجلّ
`published.json`).
...
```
ينشئ مجلد `posts/` فيه ١٨٦ صورة بأسماء `001.png … 186.png` وملف `captions_ascii.json`.
...
- الـ ١٨٦ صورة تكفي **٩٣ يومًا** (بوستين/يوم). لما تقرب تخلص، ولّد دفعة جديدة بالمهارة
